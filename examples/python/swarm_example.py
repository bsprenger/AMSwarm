...
#                                                 [0.0, 3.5167, 0.0],
#                                                 [0.0, 0.0, 3.5167]])
amswarm_kwargs["dynamics"].A = np.array([[1.00000856901154,0,	0,	0.166900420898991,	0,	0],
                                        [0,	1.00001520847075,	0,	0,	0.166900653165518,	0],
                                        [0,	0,	0.999999999997621,	0,	0,	0.166912882904496],
                                        [-0.000511509064785791,	0,	0,	0.986015217161403,	0,	0],
                                        [0,	-0.000907838114305769,	0,	0,	0.985977079274972,	0],
                                        [0,	0,	1.41963117145894e-10,	0,	0,	0.985306772357526]])
amswarm_kwargs["dynamics"].B = np.array([[0.00210589880065129,	0,	0,	0.0881241627423134,	0,	0],
                                        [0,	0.00208563161111368,	0,	0,	0.0902246894653454,	0],
                                        [0,	0,	0.000489977956084510,	0,	0,	0.0335098228759424],
                                        [0.000499918319563410,	0,	0,	0.0169195036302622,	0,	0],
                                        [0,	0.000900738796569328,	0,	0,	0.0154427226365814,	0],
                                        [0,	0,	5.76005928206621e-05,	0,	0,	0.0215842889882553]])
amswarm_kwargs["dynamics"].A_prime = np.array([[-0.000205896080648803,	0,	0,	0.994386215800223,	0,	0],
                                                [0,	-0.000365428249025069,	0,	0,	0.994382860189432,	0],
                                                [0,	0,	5.71634038359276e-11,	0,	0,	0.994083528395818],
                                                [-0.00304755111185539,	0,	0,	-0.0835777421051597,	0,	0],
                                                [0,	-0.00540883839320323,	0,	0,	-0.0840036573191221,	0],
                                                [0,	0,	8.45490137961414e-10,	0,	0,	-0.0875084973207523]])
amswarm_kwargs["dynamics"].B_prime = np.array([[0.0128871084469353,	0,	0,	0.537266057499544,	0,	0],
                                                [0,	0.0129673138734841,	0,	0,	0.549134381545362,	0],
                                                [0,	0,	0.00296885289138353,	0,	0,	0.211920352544191],
                                                [0.00297523431777396,	0,	0,	0.100669446121519,	0,	0],
                                                [0,	0.00536079303540758,	0,	0,	0.0917591169929002,	0],
                                                [0,	0,	0.000343052013646479,	0,	0,	0.128549610937201]])
